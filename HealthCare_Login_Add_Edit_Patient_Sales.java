...
class HealthCare_Login_Add_Edit_Patient_Sales 
{
	...
	//		WebElement selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(4) > .custom-control-label"));
			WebElement selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(5) > .custom-control-label"));
			...
			paymentInsurance = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(2) > .custom-control-label"));
			paymentCreditCard = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(3) > .custom-control-label"));
			paymentCash = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(4) > .custom-control-label"));
			paymentCaresAct = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(5) > .custom-control-label"));
			
			//** Uncomment the mode of payment to be tested from the 4 lines below **//
			// 1 - Insurance, 2- Credit Card, 3- Cash, 4- CaresAct
			
	//		selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(2) > .custom-control-label"));
	//		selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(3) > .custom-control-label"));
	//		selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(4) > .custom-control-label"));
			selected = driver.findElement(By.cssSelector(".form-row:nth-child(10) .custom-control:nth-child(5) > .custom-control-label"));
