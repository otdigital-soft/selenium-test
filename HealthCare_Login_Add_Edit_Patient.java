...
class HealthCare_Login_Add_Edit_Patient 
{
...
//			WebElement selected = driver.findElement(By.cssSelector("#edit_patient > div:nth-child(10) > div > div:nth-child(2) > label"));
//			WebElement selected = driver.findElement(By.cssSelector("#edit_patient > div:nth-child(10) > div > div:nth-child(3) > label"));
...
//			driver.findElement(By.id("checkEmail")).click();
			...
			String email1 = "sbadawy807+"+num+"new"+"@gmail.com";
